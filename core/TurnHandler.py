...
class TurnHandler:
    ...
    def choose_path(self, world: World) -> Path:
        ...
        path_to_enemy = []
        myself = world.get_me()
        path_to_enemy.append(world.get_shortest_path_to_cell(
            from_player=myself, cell=world.get_first_enemy().king.center))
        path_to_enemy.append(world.get_shortest_path_to_cell(
            from_player=myself, cell=world.get_second_enemy().king.center))
